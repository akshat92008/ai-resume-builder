...
import { extractProfileData, emptyCareerPathProfile } from '../../lib/careerpath/agents';
...
describe('resume parser eval', () => {
  it('extracts experience, education, and skills from career notes', () => {
    ...
    const result = extractProfileData(testInput, emptyCareerPathProfile("test-user-id", "Senior Software Engineer"), "Senior Software Engineer");
