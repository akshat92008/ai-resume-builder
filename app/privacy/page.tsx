    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-8 space-y-5 leading-7 text-slate-700">
          ...
          <p>Paid subscriptions are processed by Razorpay. CareerOS stores Razorpay customer/subscription identifiers and subscription state needed to enforce entitlements, but does not store full card numbers, UPI credentials, or card security codes.</p>
