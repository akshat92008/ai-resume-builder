    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-8 space-y-5 leading-7 text-slate-700">
          <p>CareerProof AI helps users present real achievements more clearly. You are responsible for the accuracy of every resume, portfolio, certificate, link, and claim you publish.</p>
          ...
          <p>Manual orders are reviewed by an admin before plan activation. Access limits, pricing, and beta features may change as the product evolves.</p>
          <p>By using the app, you agree to use it lawfully, respect third-party rights, and avoid uploading sensitive information you do not want processed for resume and portfolio workflows.</p>
        </div>
