    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-8 space-y-5 leading-7 text-slate-700">
          <p>CareerPath AI helps users present real achievements more clearly. You are responsible for the accuracy of every resume, portfolio, certificate, link, and claim you publish.</p>
