...
export function isPlaceholderText(value?: string) {
  ...
  return /project added during onboarding|add details in career vault|i build things|demo@example\.com|lorem ipsum|placeholder|todo|fake company|fake internship|fake metric|\[insert.*\]|\[your.*\]/i.test(value);
}
