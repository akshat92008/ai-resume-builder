...
export function isPlaceholderText(value?: string) {
  ...
  return /project added during onboarding|add details in career vault|i build things|demo@example\.com|lorem|placeholder|todo|fixme|fake company|fake internship|fake metric|analyzed job|unknown job|\[insert.*\]|\[your.*\]/i.test(value);
}
